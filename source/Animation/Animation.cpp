...
int Animation::sideSlideIn(QWidget* _widget,
                           WAF::ApplicationSide _side,
                           bool _decorateBackground)
{
  const bool IN = true;
  return sideSlide(_widget, _side, _decorateBackground, IN);
}

int Animation::sideSlideOut(QWidget* _widget,
                            WAF::ApplicationSide _side,
                            bool _decorateBackground)
{
...
int Animation::sideSlide(QWidget* _widget,
                         WAF::ApplicationSide _side,
                         bool _decorateBackground,
                         bool _in)
{
  const AnimationPrivate::AnimatorType animatorType =
      AnimationPrivate::SideSlide;
  AbstractAnimator* animator = 0;
  if (pimpl()->hasAnimator(_widget, animatorType)) {
    animator = pimpl()->animator(_widget, animatorType);
    if (SideSlideAnimator* sideSlideAnimator =
...
int Animation::slideIn(QWidget* _widget,
...
int Animation::slideOut(QWidget* _widget,
                        WAF::AnimationDirection _direction,
                        bool _fixBackground,
                        bool _fixStartSize)
{
...
int Animation::slide(QWidget* _widget,
                     WAF::AnimationDirection _direction,
                     bool _fixBackground,
                     bool _fixStartSize,
                     bool _in)
...
int Animation::circleFillIn(QWidget* _widget,
                            const QPoint& _startPoint,
                            const QColor& _fillColor,
...
int Animation::circleFillOut(QWidget* _widget,
                             const QPoint& _startPoint,
                             const QColor& _fillColor,
                             bool _hideAfterFinish)
{
...
int Animation::circleFill(QWidget* _widget,
                          const QPoint& _startPoint,
                          const QColor& _fillColor,
                          bool _hideAfterFinish,
                          bool _in)
{
  const AnimationPrivate::AnimatorType animatorType =
      AnimationPrivate::CircleFill;
  AbstractAnimator* animator = 0;
  if (pimpl()->hasAnimator(_widget, animatorType)) {
    animator = pimpl()->animator(_widget, animatorType);
    if (CircleFillAnimator* circleFillAnimator =
            qobject_cast<CircleFillAnimator*>(animator))
    {
...
int Animation::expand(QWidget* _widget,
                      const QRect& _expandRect,
                      const QColor& _fillColor,
                      bool _in)
{
  ...
  if (pimpl()->hasAnimator(_widget, animatorType)) {
    animator = pimpl()->animator(_widget, animatorType);
    if (ExpandAnimator* expandAnimator =
            qobject_cast<ExpandAnimator*>(animator))
    {
