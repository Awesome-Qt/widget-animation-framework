 ...
 */
class WIDGET_ANIMATION_FRAMEWORK_EXPORT Animation
{
public:
  /**
   * @brief Выкатить виджет из-за стороны приложения
   */
  static int sideSlideIn(QWidget* _widget,
                         ApplicationSide _side = LeftSide,
                         bool _decorateBackground = true);

  /**
   * @brief Закатить виджет из-за стороны приложения
   */
  static int sideSlideOut(QWidget* _widget,
                          ApplicationSide _side = LeftSide,
                          bool _decorateBackground = true);
   ...
   */
  static int sideSlide(QWidget* _widget,
                       ApplicationSide _side = LeftSide,
                       bool _decorateBackground = true,
                       bool _in = true);
   ...
   */
  static int slideIn(QWidget* _widget,
                     AnimationDirection _direction,
                     bool _fixBackground = true,
                     bool _fixStartSize = false);

  /**
   * @brief Закатить виджет
   */
  static int slideOut(QWidget* _widget,
                      AnimationDirection _direction,
                      bool _fixBackground = true,
                      bool _fixStartSize = false);
   ...
   */
  static int slide(QWidget* _widget,
                   AnimationDirection _direction,
                   bool _fixBackground = true,
                   bool _fixStartSize = false,
                   bool _in = true);
   ...
   */
  static int circleFillIn(QWidget* _widget,
   ...
   * @brief Заполнить/очистить цветовым кругом
   */
  static int circleFillOut(QWidget* _widget,
                           const QPoint& _startPoint,
                           const QColor& _fillColor,
                           bool _hideAfterFinish = true);
   ...
   * @brief Заполнить/очистить цветовым кругом
   */
  static int circleFill(QWidget* _widget,
                        const QPoint& _startPoint,
                        const QColor& _fillColor,
                        bool _hideAfterFinish = true,
                        bool _in = true);
   ...
   */
  static int expand(QWidget* _widget,
