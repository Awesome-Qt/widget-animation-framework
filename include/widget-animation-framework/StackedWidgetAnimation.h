 ...
 */
class WIDGET_ANIMATION_FRAMEWORK_EXPORT StackedWidgetAnimation
{
public:
  /**
   * @brief Выкатить заданный виджет, смещая текущий активный
   */
  static void slide(QStackedWidget* _container,
                    QWidget* _widget,
   ...
   */
  static void slideOverIn(QStackedWidget* _container,
                          QWidget* _widget,
                          AnimationDirection _direction);
   ...
   */
  static void slideOverOut(QStackedWidget* _container,
                           QWidget* _widget,
                           AnimationDirection _direction);
   ...
   */
  static void slideOver(QStackedWidget* _container,
                        QWidget* _widget,
                        AnimationDirection _direction,
                        bool _in);
